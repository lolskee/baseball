...
## get html code for odds based on desired line type and date
    ...
    soup = soup_big.findAll('div', id='OddsGridModule_3')[0]
...
## Parse HTML to gather line data by book
    def book_line(book_id, line_id, homeaway):
        ...
        line = soup.findAll('div', attrs = {'class':'el-div eventLine-book', 'rel':book_id})[line_id].findAll('div')[homeaway].get_text().strip()
        return line
    '''
    BookID  BookName
    238     Pinnacle
    ...
    number_of_games = len(soup.findAll('div', attrs = {'class':'el-div eventLine-rotation'}))
